...
public class New_cont extends AppCompatActivity implements View.OnClickListener{
    private CardView wa, gmail, insta;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_new_cont);
